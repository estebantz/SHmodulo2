...
function buildToDo(todo, index) {
 ...
 toDoShell.className = "toDoShell"; // <div className="toDoShell">  </div>

 let toDoText = document.createElement("span")
 toDoText.innerHTML = todo.description;         // <span>Limpiar la casa</span>
 toDoText.id = index;        // <span id="index">Limpiar la casa</span>

 if (todo.complete) {
  toDoText.className = "completeText"; // <span id="index" className="completeText">Limpiar la casa</span>
 }
 ...
 // <span id="index" className="completeText"> Limpiar la casa </span>
 // </div>
 return toDoShell;
}
...
function displayToDos() {
  ...
  for (let i = 0; i < toDoBuilt.length; i++) {
    toDoContainer.appendChild(toDoBuilt[i]);
  }
}
